...
class TestCurriculumLoop(unittest.TestCase):
    ...
    # ------------------------------------------------------------------
    # Test 1: Task.init called once per stage
    # ------------------------------------------------------------------

    def test_task_init_called_once_per_stage(self):
        r = self._run()
        self.assertEqual(r["task_cls"].init.call_count, 3)
    ...
    # ------------------------------------------------------------------
    # Test 3: task.close() called once per stage
    # ------------------------------------------------------------------

    def test_task_close_called_after_each_stage(self):
        r = self._run()
        self.assertEqual(r["task_inst"].close.call_count, 3)
    ...
    def test_train_dataloader_receives_correct_curriculum_stage(self):
        ...
        self.assertEqual(sorted(val_stages), [1, 2, 3])
